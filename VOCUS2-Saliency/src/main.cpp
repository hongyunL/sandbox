...
void print_usage(char* argv[]){
	...
	cout << "   -x" << "\t\t" << "Config file (is loaded first, additional options have higher priority)" << endl << endl;

	cout << "   -C" << "\t\t" << "Used colorspace [default: 1]:" << endl;
	cout << "\t\t   " << "0: LAB" << endl;
	cout << "\t\t   " << "1: Opponent (CoDi)" << endl;
	cout << "\t\t   " << "2: Opponent (Equal domains)\n" << endl;

	cout << "   -f" << "\t\t" << "Fusing operation (Feature maps) [default: 0]:" << endl;
	cout << "   -F" << "\t\t" << "Fusing operation (Conspicuity/Saliency maps) [default: 0]:" << endl;

	cout << "\t\t   " << "0: Arithmetic mean" << endl;
	cout << "\t\t   " << "1: Max" << endl;
	cout << "\t\t   " << "2: Uniqueness weight\n" << endl;

	cout << "   -p" << "\t\t" << "Pyramidal structure [default: 2]:" << endl;
	...
	cout << "   -l" << "\t\t" << "Start layer (included) [default: 0]" << endl << endl;

	cout << "   -L" << "\t\t" << "Stop layer (included) [default: 4]" << endl << endl;

	cout << "   -S" << "\t\t" << "No. of scales [default: 2]" << endl << endl;

	cout << "   -c" << "\t\t" << "Center sigma [default: 2]" << endl << endl;

	cout << "   -s" << "\t\t" << "Surround sigma [default: 10]" << endl << endl;
	
	//cout << "   -r" << "\t\t" << "Use orientation [default: off]  " << endl << endl;

	cout << "   -e" << "\t\t" << "Use Combined Feature [default: on]" << endl << endl;
	...
	cout << "   -t" << "\t\t" << "MSR threshold (percentage of fixation) [default: 0.75]" << endl << endl;

	cout << "   -N" << "\t\t" << "No visualization" << endl << endl;
	
	cout << "   -o" << "\t\t" << "WRITE results to specified path [default: <input_path>/saliency/*]" << endl << endl;

	cout << "   -w" << "\t\t" << "WRITE all intermediate maps to an existing folder" << endl << endl;
...
bool process_arguments(int argc, char* argv[], VOCUS2_Cfg& cfg, vector<char*>& files){
	...
	while((c = getopt(argc, argv, "bnreNhVC:x:f:F:v:l:o:L:S:c:s:t:p:w:G:")) != -1){
		...
		case 'e': cfg.combined_features = false; break;
